...
public class ContactFormTest {
    ...
    public void saveEventHasCorrectValues(){
        ...
        assertEquals("John", form.firstName.getValue());
        assertEquals("Doe",form.lastName.getValue());
        assertEquals("john@doe.com",form.email.getValue());
        assertEquals(company1, form.company.getValue());
        assertEquals(status2,form.status.getValue());
    }
}